...
let newName = checkForName()

// makes a get request to get the name of the host
function getName() {
...
async function checkForName() {
  ...
  let changeName = document.getElementById('username')
  changeName.textContent = `${name.username}`
}
